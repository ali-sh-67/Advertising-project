...
@section('content')
    <div style="width:1200px;height:511px;border:1px solid black;margin:5px auto;background-color:seashell;">
        <div style="width:200px;height:480px;border:1px solid black;float:right;margin-top:15px;margin-right:15px;background-color:#fff;">
            <div style="text-align:center;text-decoration: none ;"><a  href="{{route('indexAd')}}">کل آگهی ها</a></div>
